...
<!--                <h2>Borrowed Collection</h2>-->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header ">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 teacher_profile_label"><h2>Add Fine Setting</h2>
                            </div>
                        </div>
                        <div class="modal-body">
                            <?php echo form_open_multipart('library/addFineSetting'); ?>
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-5 col-sm-3 col-xs-11 teacher_profile_label">Type</div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-5 col-sm-3 col-xs-11 teacher_profile_label">Fine (IDR)</div>
                                    <div class="col-md-7 col-sm-9 col-xs-12">
        ...
        <a data-toggle="modal" data-target="#upload" class="btn btn-primary" style="margin-bottom: 2vw" ><!--<i class="fa fa-plus"></i>--> Add Fine Setting</a>
