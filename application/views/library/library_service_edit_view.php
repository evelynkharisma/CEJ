            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="container" style="margin-bottom: 15px">
                    ...
                    <div class="container" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-10 col-sm-9 col-xs-12">
                            <textarea id="long-text" class="form-control set-margin-bottom" name="content" rows="10" placeholder="Description"><?php echo isset($service['content']) ? htmlspecialchars_decode($service['content']) : ''; ?></textarea>
                        </div>
                    </div>
