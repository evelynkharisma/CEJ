<?php $privilege = $this->general->checkPrivilege($this->nativesession->get('role'), 'p0035');
if($privilege == 1){?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <a href="<?php echo base_url() ?>index.php/library/allCollection" class="btn btn-primary lib-top-btn">All Collection</a>
