...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title col-md-12 col-sm-12 col-xs-12">
            ...
            <div>
                <div class="dropdown parent_report_gradeDropdown">
                    <button class="btn btn-default dropdown-toggle dropdown-menu-right" type="button" id="menu1" data-toggle="dropdown">Grade 11
                        <span class="caret"></span></button>
                    <ul class="dropdown-menu dropdown-menu-content" role="menu" aria-labelledby="menu1">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="teacher_course_student_mid table-bordered">
                        <tbody><tr>
                            <td width="50%" class="teacher_course_student_mid_td parent_report_coursename">Mathematic</td>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="teacher_course_student_mid table-bordered">
                        <tbody><tr>
                            <td width="50%" class="teacher_course_student_mid_td parent_report_coursename">English</td>
                            <td class="teacher_course_student_mid_td set-center">1</td>
                            <td class="teacher_course_student_mid_td set-center">2</td>
                            <td class="teacher_course_student_mid_td set-center">3</td>
                            <td class="teacher_course_student_mid_td set-center">4</td>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="teacher_course_student_mid table-bordered">
                        <tbody><tr>
                            <td width="50%" class="teacher_course_student_mid_td parent_report_coursename">Science</td>
                            <td class="teacher_course_student_mid_td set-center">1</td>
                            <td class="teacher_course_student_mid_td set-center">2</td>
                            <td class="teacher_course_student_mid_td set-center">3</td>
                            <td class="teacher_course_student_mid_td set-center">4</td>
