...
<div class="right_col" role="main">
    <div class="">
        ...
        ?>
        <?php echo form_open_multipart("parents/profile_edit/".$encrypted); ?>
        <div class="row">
                    ...
                    <div class="x_content">
                        <div class="col-md-12 col-sm-12 col-xs-12 profile_left">
                            ...
                            <ul class="list-unstyled user_data">
                                <li>
                                    <i class="fa fa-user user-profile-icon"></i> ID: <?php echo $parent['parentid']; ?>
                                </li>
                            </ul>
                                    ...
                                    <div class="teacher_profile_group">
                                        ...
                                        <div class="teacher_profile_value">
                                            <select class="form-control set-margin-bottom" name="gender">
                                                <option selected value="<?php echo $parent['gender'] ?>"><?php echo $parent['gender'] ?></option>
                                                <?php if(strcmp($parent['gender'],'Male')==0):
                                                    echo "<option value='Female' >Female</option>";
                                                endif;
                                                ?>
                                                <?php if(strcmp($parent['gender'],'Female')==0):
