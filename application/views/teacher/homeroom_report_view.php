            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a target="_blank" href="<?php echo base_url() ?>index.php/teacher/printPreview13/<?php echo $info_db['studentid'] ?>/<?php echo $term ?>" class="btn btn-success set-right"><i class="fa fa-eye"></i> Print Preview</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div class="col-md-12 col-sm-12 col-xs-12">
