            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        ?>
                        <h2><?php echo $qna['topic'] ?> <?php echo $qna['type'] ?> Submission</h2><a href="<?php echo base_url() ?>index.php/admin/sendQnAEmailToAll/<?php echo $notifencrypted ?>/<?php echo $notifqencrypted ?>" class="btn btn-danger set-right"><i class="fa fa-bell-o"></i> Notify All</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                $sencrypted = $this->general->encryptParaID($s['studentid'],'student');
                                            ?>
                                            <?php echo form_open('admin/courseSubmissionGrading/'.$encrypted.'/'.$qencrypted); ?>
                                            <input type="hidden" class="form-control set-margin-bottom" name="studentid" value="<?php echo $s['studentid']; ?>"/>
                                            <input type="hidden" class="form-control set-margin-bottom" name="qnaid" value="<?php echo $qna['anqid']; ?>"/>
                                            <button type="submit" class="btn btn-success set-right"><i class="fa fa-check"></i></button>
                                            <input style="width:70%;" class="form-control" placeholder='Score' name="score" value="<?php echo set_value('score', isset($s['score']) ? $s['score'] : ''); ?>">
                                            <?php echo form_close(); ?>
                                        <td><a href="<?php echo base_url() ?>index.php/admin/sendQnAEmail/<?php echo $sencrypted ?>/<?php echo $notifqencrypted ?>" class="btn btn-danger"><i class="fa fa-bell-o"></i> Notify</a></td>
                                    </tr>
                                <?php } }?>
                            </tbody>
                        </table>
