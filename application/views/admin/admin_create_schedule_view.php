...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            ...
            <a href="<?php echo base_url() ?>index.php/admin/generateSchedule" class="btn btn-success set-right"><i class="fa fa-braille"></i> Generate</a>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <?php echo form_open_multipart('admin/addScheduleSetting'); ?>
                                ...
                                foreach($assign as $info_db){ ?>
                                    <tr>
                                        ...
                                        <td width="20%">
                                            ...
                                            ?>
                                            <a href="<?php echo base_url() ?>index.php/admin/deleteScheduleSetting/<?php echo $encrypted ?>" class="btn-success btn" onclick="return confirm('Are you sure want to delete this?');"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php }}
                            else {?>
