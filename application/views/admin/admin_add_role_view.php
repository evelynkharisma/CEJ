...
<div class="right_col" role="main">
    <div class="">
        ...
        <?php endif; ?>
        <?php echo form_open_multipart("admin/addRole/");?>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <input type="hidden" class="form-control set-margin-bottom" name="roleid" value="<?php echo $newroleid; ?>"/>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="teacher_profile_group">
                                        <div class="teacher_profile_value">
                                            <input type="text" class="form-control set-margin-bottom" name="roleid" value="<?php echo $newroleid ?>" readonly/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="teacher_profile_group">
                                        <div class="teacher_profile_value">
                                            <input type="text" class="form-control set-margin-bottom" name="rolename" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
