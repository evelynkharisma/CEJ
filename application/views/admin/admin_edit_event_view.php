            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        ?>
                        <?php echo form_open_multipart('admin/editEvent/'.$encrypted); ?>
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <?php echo form_open_multipart('admin/addEventImage/'.$encrypted); ?>
                                                                <div class="form-group">
                                ...
                                foreach($images as $info_db){ ?>
                                    <tr>
                                        ...
                                        <td width="30%">
                                            ...
                                            ?>
                                                <a href="<?php echo base_url() ?>index.php/admin/deleteEventImage/<?php echo $iencrypted ?>/<?php echo $encrypted ?>" class="btn-success btn" onclick="return confirm('Are you sure want to delete this?');"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php }}
                            else {?>
