        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Semester Plan</h2>
                        <a href="<?php echo base_url() ?>index.php/admin/printPreviewSemester/<?php echo $encrypted ?>" target="_blank" class="btn btn-success set-right"><i class="fa fa-eye"></i> Print Preview</a>
                        <a class="btn btn-success set-right" href="<?php echo base_url() ?>index.php/admin/editSemester/<?php echo $encrypted ?>"><i class="fa fa-edit m-right-xs"></i> Edit Semester Plan</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
