                    ...
                    <div class="x_content">
                        <div class="col-md-12 col-sm-12 col-xs-12 profile_left">
                            ...
                            <ul class="list-unstyled user_data">
                                <li>
                                    <i class="fa fa-briefcase user-profile-icon"></i> <?php echo $newstudentid; ?>
                                </li>
                            </ul>
                        ...
                        <input type="hidden" class="form-control set-margin-bottom" name="studentid" value="<?php echo $newstudentid; ?>"/>
                        <div class="col-md-12 col-sm-12 col-xs-12">
