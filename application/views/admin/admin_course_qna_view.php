            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        ?>
                        <h2>Assignment and Quizzes</h2><a href="<?php echo base_url() ?>index.php/admin/addQnA/<?php echo $encrypted ?>" class="btn btn-success set-right"><i class="fa fa-upload"></i> Upload</a>
                                ...
                                foreach($qnas as $qna){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <a download href="<?php echo base_url() ?>assets/file/admin/material/<?php echo $qna['filename'] ?>" class="btn btn-success"><i class="fa fa-download"></i> Download</a>
                                            <a href="<?php echo base_url() ?>index.php/admin/courseAssignmentQuizSubmission/<?php echo $encrypted ?>/<?php echo $qencrypted ?>" class="btn btn-yellow"><i class="fa fa-child"></i> Submission</a>
                                            <a href="<?php echo base_url() ?>index.php/admin/sendQnAEmailToAll/<?php echo $encrypted ?>/<?php echo $qencrypted ?>" class="btn btn-danger"><i class="fa fa-bell-o"></i> Notify</a>
                                        </td>
                                    </tr>
                                <?php } }?>
                            </tbody>
